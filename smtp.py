...
ADMINS = [id]  # ID администраторов
TARGET_EMAIL = "mail"  # Почта на которую летят жб (поменять на свою)
...
MESSAGES = {
    ...
    "no_subscription": "⚡ У вас нет активной подписки! Для приобретения обратитесь к @IntelBreak",
